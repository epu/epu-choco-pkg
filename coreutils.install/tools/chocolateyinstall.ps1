...
$packageName = 'coreutils.install' # arbitrary name for the package, used in messages
$registryUninstallerKeyName = 'coreutils.install' #ensure this is the value in the registry
$installerType = 'exe' #only one of these: exe, msi, msu
$url = 'http://sourceforge.net/projects/gnuwin32/files/coreutils/5.3.0/coreutils-5.3.0.exe' # download url
