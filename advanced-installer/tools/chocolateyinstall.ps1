...
$packageName = 'advanced-installer' # arbitrary name for the package, used in messages
$registryUninstallerKeyName = 'advanced-installer' #ensure this is the value in the registry
$installerType = 'Msi' #only one of these: exe, msi, msu
$url = 'http://www.advancedinstaller.com/downloads/10.6/advinst.msi' # download url
